...
const Footer = () => {
  ...
  return (
    <div className='w-full relative bottom-0 bg-[#2f2f2f] backdrop-filter backdrop-blur-lg bg-opacity-30 flex flex-col justify-center items-center md:px-20 p-10 z-10'>
